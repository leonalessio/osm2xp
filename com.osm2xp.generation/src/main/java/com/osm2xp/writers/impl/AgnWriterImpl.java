...
//		String agn2txt = "C:/Documents and Settings/bblanche/Bureau/latest_development_releases_package" //XXX old absolute path here
//				+ File.separatorChar + "txt2agn.exe";
		String txt2agn =  "txt2agn.exe";
...
//					+ filePath, "agnCompilation", txt2agn + " " + sceneFolder
//					+ File.separator + filePath + " " + sceneFolder);
//			
//			job.setRule(new MutexRule());
//			job.schedule();
			ProcessExecutor.getExecutor().execute(new RunProcessRunnable(txt2agn + " " + sceneFolder
					+ File.separator + filePath + " " + sceneFolder));
