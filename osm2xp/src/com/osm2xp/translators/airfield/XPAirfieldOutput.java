...
public class XPAirfieldOutput {
	...
	public void writeAirfield(AirfieldData airfieldData) {
		...
		File airfieldFolder = new File(baseFolder, OSM2XP_AIRFIELD_PREFFIX + id);
		for (int i = 0; airfieldFolder.exists() && i < Integer.MAX_VALUE; i++) {
			airfieldFolder = new File(baseFolder, OSM2XP_AIRFIELD_PREFFIX + id + i);
		}
		File dataFolder = new File(airfieldFolder, "Earth nav data");
		dataFolder.mkdirs();
