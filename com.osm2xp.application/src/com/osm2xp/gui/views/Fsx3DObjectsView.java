...
import com.osm2xp.gui.views.panels.fsx.FsxObjectsRulesPanel;
 ...
 * 
 */
public class Fsx3DObjectsView extends AbstractOptionsView implements IContextProvider {

	public Fsx3DObjectsView() {
	...
	protected void createFormControls() {
		...
		sectionObjectsRules.setLayoutData(new TableWrapData(TableWrapData.FILL_GRAB, TableWrapData.TOP, 1, 1));

		sectionObjectsRules.setText("objects rules");
		FsxObjectsRulesPanel objectsRulesPanel = new FsxObjectsRulesPanel(sectionObjectsRules, SWT.BORDER);
